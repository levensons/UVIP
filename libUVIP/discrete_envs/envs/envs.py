...
from libUVIP.discrete_envs.envs.env_base import BaseEnvironment
from libUVIP.utils.utils_discrete import get_dynamics
import gym
...
class EnvFactory:
    def __init__(self, name):
        self.env = None
        try:
            self.env = getattr(sys.modules[__name__], name)
        except err:
            print("There is no environment called: " + name)
