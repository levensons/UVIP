...
if __name__ == "__main__":
    ...
    scores = TabularReinforce(env,
                              gamma=alg_conf['gamma'],
                              save_path=alg_conf['save_path_reinforce'],
                              lr=alg_conf['lr'],
    ...
    Vstar, Vup, _ = ComputeFastPreciseUVIP(env, policy,
                                           gamma=alg_conf['gamma'],
                                           eps=float(alg_conf['UVIP_accuracy']),
                                           save_path=alg_conf['save_path_UVIP'])
